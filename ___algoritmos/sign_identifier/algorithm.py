...
if __name__ == '__main__':
    ...
    from database import (instance_, command)
    ...
    while True:
        ...
        if the_name:
            ...
            arguments = (new_person.name, new_person.birthday)
            syntax = "INSERT INTO pessoas (nome, nascimento) VALUES (%s, %s)"
            command.execute(syntax, arguments)
            instance_.commit()
            # break
